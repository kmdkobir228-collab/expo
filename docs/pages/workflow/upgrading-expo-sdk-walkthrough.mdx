...
_Learn how to incrementally upgrade the Expo SDK version in your project._
...
Upgrade all dependencies to match the installed SDK version. Then run [`expo-doctor`](https://docs.expo.dev/develop/tools/#expo-doctor) command to check for common problems.
